...
class Tenant(Base):
    ...
    company_profile: Mapped[Optional[Dict[str, Any]]] = mapped_column(
        JSON, nullable=True
    )  # Industry, location, primary goal, etc.

    branding_config: Mapped[Optional[Dict[str, Any]]] = mapped_column(
        JSON, nullable=True
    )  # logo_url, primary_color, system_persona, etc.
